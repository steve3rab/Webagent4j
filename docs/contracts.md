...
| `EXECUTION_FAILED` | `NOT_EXECUTED` | `TARGET_NOT_FOUND`, `TARGET_AMBIGUOUS`, `BACKEND_FAILURE`, `POLICY_DENIED`, `POLICY_EVALUATION_FAILED`, or `TARGET_CHANGED` |
| `EXECUTION_FAILED` | `REAL` | `TARGET_NOT_INTERACTABLE`, `ACTION_NOT_SUPPORTED_BY_TARGET`, `BACKEND_FAILURE`, `UPLOAD_FAILURE`, `DOWNLOAD_FAILURE`, `POLICY_VIOLATION`, or `STABILIZATION_FAILED` |
