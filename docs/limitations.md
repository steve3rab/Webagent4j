...
- No recursion over data, DAG scheduler, parallel branches or parallel loop iterations, fork/join, `switch`/`case`, workflow variables reassignable across branches, transactions/sagas, persistence, checkpoint/resume, scheduling, cron, external event triggers, or YAML/JSON workflow language.
