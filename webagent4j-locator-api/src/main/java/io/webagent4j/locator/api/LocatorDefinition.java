...
public record LocatorDefinition(
    ...
    private LocatorDefinition copy(
        ...
        return new LocatorDefinition(
                ...
                nextAccessibleName == null ? accessibleName : nextAccessibleName,
                nextLabel == null ? label : nextLabel,
                nextPlaceholder == null ? placeholder : nextPlaceholder,
                nextTitle == null ? title : nextTitle,
                nextAltText == null ? altText : nextAltText,
                nextVisibleText == null ? visibleText : nextVisibleText,
                nextId == null ? id : nextId,
                nextNameAttribute == null ? nameAttribute : nextNameAttribute,
                nextAttributes == null ? attributes : nextAttributes,
                nextTestId == null ? testId : nextTestId,
                nextCss == null ? css : nextCss,
                nextXpath == null ? xpath : nextXpath,
                nextVisible == null ? visible : nextVisible,
                nextEnabled == null ? enabled : nextEnabled,
                nextEditable == null ? editable : nextEditable,
                nextChecked == null ? checked : nextChecked,
                nextSelected == null ? selected : nextSelected,
                nextTimeout == null ? timeout : nextTimeout,
                nextWaitUntilVisible == null ? waitUntilVisible : nextWaitUntilVisible,
                readOnly,
                focused,
                inViewport,
                clickable,
    ...
    private LocatorDefinition copyState(
        ...
        return new LocatorDefinition(
                ...
                timeout,
                waitUntilVisible,
                nextReadOnly == null ? readOnly : nextReadOnly,
                nextFocused == null ? focused : nextFocused,
                nextInViewport == null ? inViewport : nextInViewport,
                nextClickable == null ? clickable : nextClickable,
                nextCovered == null ? covered : nextCovered,
                nextStability == null ? stability : nextStability);
    }
